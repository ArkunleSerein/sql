...
SELECT *
FROM student
WHERE (created_at >= '2021-01-01 00:00:00'AND created_at <= '2021-01-10')
...
SELECT *
FROM student
WHERE (email = '%.fr'AND created_at <= '2021-01-10') OR project_id >= TRUE
...
SELECT *
FROM student
WHERE (email = '%.fr'AND created_at <= '2021-01-10') AND project_id IS NULL
