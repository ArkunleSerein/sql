...
--
CREATE DATABASE IF NOT EXISTS `location_voiture` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `vehicule` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_vehicule_statut_id` (`status_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `vehicule`
  ADD CONSTRAINT `fk_vehicule_statut_id` FOREIGN KEY (`status_id`) REFERENCES `statut` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
