...
WHERE project.id = student.id;

-- Exo 4.4
-- Listez le project dont l'id est `3` avec ses students
SELECT * 
FROM project INNER JOIN student
WHERE project.id = 3 AND student.id = student_id
